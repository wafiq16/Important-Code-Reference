...
const char* ssid = "wafiqNodeMcu";
const char* password = "12344321";

const char* host = "script.google.com";

// Replace with your own script id to make server side changes
//https://docs.google.com/spreadsheets/d/1anw_YN8ni-O8ERjslL7AVyunxO7BsmjsomU_mi3GuHA/edit#gid=0
const char *GScriptId = "1anw_YN8ni-O8ERjslL7AVyunxO7BsmjsomU_mi3GuHA";
