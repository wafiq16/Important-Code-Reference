...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(Button_Juri_Standby), IT_HANDLER, FALLING);
...
void loop() {
  ...
  if (siap) {
    Serial.println("SIAP");
    int a = digitalRead(Button_Tim_A);
    delay(30);
    int b = digitalRead(Button_Tim_B);
    delay(30);
    int c = digitalRead(Button_Tim_C);
    delay(30);
    if (a) {
      tim_a_jawab = true;
