...
#define BOT_TOKEN "1824572262:AAG4B-_ok16HayHAftQzqV_H1CWqi-KWZzs"

String ssid = "hehehe";     // REPLACE mySSID WITH YOUR WIFI SSID
String pass = "12345679"; // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
char *token = "1824572262:AAG4B-_ok16HayHAftQzqV_H1CWqi-KWZzs";   // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
